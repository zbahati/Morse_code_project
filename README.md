...
# 📖 Morse code PROJECT <a name="about-project"></a>

**[Morse_code project ]** is a method used in telecommunication to encode text characters as standardized sequences of two different signal durations, called dots and dashes, or dits and dahs. Morse code is named after Samuel Morse, one of the inventors of the telegraph.
...
```sh
  git clone https://github.com/zbahati/Morse_code.git
  cd Morse_code
...
Feel free to check the [issues page](https://github.com/zbahati/Morse_code/issues).
